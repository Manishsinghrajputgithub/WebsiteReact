                        ...
                        <div className="col-6">
                            <figure className="product-media">
                                <ALink href={ `/product/default/${product.slug}` }>
                                    <img src={ process.env.NEXT_PUBLIC_ASSET_URI + product.sm_pictures[ 0 ].url } alt="product" width={ product.sm_pictures[ 0 ].width } height={ product.sm_pictures[ 0 ].height } className="h-100" />
                                </ALink>
                            </figure>
